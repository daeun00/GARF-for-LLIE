...
parser.add_argument('--modelfile', default='models/LIENet.pth', help='sr pretrained base model')
...
def eval():
    model.eval()
    TestFolder = ['LOL','DICM', 'LIME', 'Fusion', 'MEF', 'VV','NPE']
    for i in range(TestFolder.__len__()):
        ...
        print("===> Processing Time: %.4f ms." % (time_ave))
